$(function(){
  ...
  $(".form-details").validate({
    ...
    messages: {
      contact: {
        required: "Please, insert a valid cantact info (e-mail or cellphone number)",
        minlength: "Too short"
        },
      name: {
      ...
      surname: {
        required: "Please, insert a valid surname",
        minlength: "Too short"
      },
      address: {
      ...
      city: {
        required: "Please, insert a valid city",
        minlength: "Too short"
      },
      province: {
      ...
      postalCode: {
        required: "Insert a valid postal code",
